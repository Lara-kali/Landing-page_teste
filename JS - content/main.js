$(document).ready(() => {
    ...
    $('<main>').append(
        ...
        $('<section>').addClass('splide').attr('id', 'image-carousel').append(
            $('<div>').addClass('splide__track').append(
                $('<ul>').addClass('splide__list').append(
                        $.map(carrousel[1]['collection_img'], function (i) {
                            return $('<li>').addClass('splide__slide').append(
                                $('<img>').attr('src', i)
                            )
                        })
                )
